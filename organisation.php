...
<table class="table table-hover table-bordered results">
           ...
           while ($row = mysqli_fetch_assoc($result_organisation))
           {
                echo '
                     <tr>
                     ...
                     <td>'.$row["Phone"].'</td>
					 <td> 
					 <a href="manipulate.php?org='.$row["OrganisationID"].'"><i class="fa fa-pencil" title="Edit"></i></a>
					 &nbsp;
					 <a href="?remove_organisation='.$row["OrganisationID"].'" onclick="return confirm(\'Are you sure you wish to proceed?\')"><i class="fa fa-trash" title="DELETE"></i></a>
					 </td>
                </tr>
                ';
           }
