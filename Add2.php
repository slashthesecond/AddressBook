...
<body>
    ...
    <div class="contact-clean">
        <form method="post">
            <h2 class="text-center">Add Organisation</h2>
            <div class="form-group"><input class="form-control" type="text" name="Organisationname" placeholder="Organisation name" required></div>
            ...
            <div class="form-group"><button class="btn btn-primary" name="add_organisation" type="submit">Add</button></div>
        </form>
    </div>
